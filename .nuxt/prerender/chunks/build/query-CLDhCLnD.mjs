import { ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref } from 'file:///home/jes/dealornodeal_web/node_modules/vue/index.mjs';
import { h as asyncDataDefaults, g as useNuxtApp, j as createError, b as useRuntimeConfig, k as useRequestEvent } from './server.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash, withBase } from 'file:///home/jes/dealornodeal_web/node_modules/ufo/dist/index.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-DFce90FL.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-CLDhCLnD.mjs.map
