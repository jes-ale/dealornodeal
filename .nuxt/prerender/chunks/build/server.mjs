import { hasInjectionContext, inject, version, unref, h, toRef, isRef, defineComponent, ref, provide, createElementBlock, defineAsyncComponent, useSlots, reactive, computed, resolveComponent, onUpdated, getCurrentInstance, onUnmounted, shallowReactive, watch, Suspense, nextTick, Transition, Fragment, useSSRContext, createApp, effectScope, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, Text, markRaw, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, onScopeDispose } from 'file:///home/jes/dealornodeal_web/node_modules/vue/index.mjs';
import { $fetch } from 'file:///home/jes/dealornodeal_web/node_modules/ofetch/dist/node.mjs';
...
import { createError as createError$1, sanitizeStatusCode, getRequestHeaders } from 'file:///home/jes/dealornodeal_web/node_modules/h3/dist/index.mjs';
import { getActiveHead } from 'file:///home/jes/dealornodeal_web/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/jes/dealornodeal_web/node_modules/@unhead/shared/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION, useRouter as useRouter$1, useRoute as useRoute$1 } from 'file:///home/jes/dealornodeal_web/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///home/jes/dealornodeal_web/node_modules/radix3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL, isEqual } from 'file:///home/jes/dealornodeal_web/node_modules/ufo/dist/index.mjs';
import { setupDevtoolsPlugin } from 'file:///home/jes/dealornodeal_web/node_modules/vue-devtools-stub/dist/index.mjs';
import sync, { getFrameData } from 'file:///home/jes/dealornodeal_web/node_modules/framesync/dist/es/index.mjs';
import { inertia, animate, velocityPerSecond, cubicBezier, linear, easeIn, easeInOut, easeOut, circIn, circInOut, circOut, backIn, backInOut, backOut, anticipate, bounceIn, bounceInOut, bounceOut } from 'file:///home/jes/dealornodeal_web/node_modules/popmotion/dist/es/index.mjs';
import { number as number$1, px, color, degrees, scale, alpha, progressPercentage, filter, complex } from 'file:///home/jes/dealornodeal_web/node_modules/style-value-types/dist/es/index.mjs';
import { isHTMLTag } from 'file:///home/jes/dealornodeal_web/node_modules/@vue/shared/dist/shared.cjs.prod.js';
import { parse as parse$1, serialize } from 'file:///home/jes/dealornodeal_web/node_modules/cookie-es/dist/index.mjs';
import isHTTPS from 'file:///home/jes/dealornodeal_web/node_modules/is-https/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///home/jes/dealornodeal_web/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./confirm-D31u1oW3.mjs').then((m) => m.default || m)
  },
  {
    name: "game",
    path: "/game",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-CQ36ROCt.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./index-CEgGgxzE.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$7 == null ? void 0 : __nuxt_page_meta$7.name) ?? "login",
    path: (__nuxt_page_meta$7 == null ? void 0 : __nuxt_page_meta$7.path) ?? "/login",
    ...
    component: () => import('./login-BdFeLvcy.mjs').then((m) => m.default || m)
  },
  {
    name: "partner-form",
    path: "/partner/form",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./form-DlnjC5gh.mjs').then((m) => m.default || m)
  },
  {
    name: "partner-kanban",
    path: "/partner/kanban",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./kanban-pDwzL5iq.mjs').then((m) => m.default || m)
  },
  {
    name: "partner-list",
    path: "/partner/list",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./list-DpoXMTm2.mjs').then((m) => m.default || m)
  },
  {
    name: "user-form-id",
    path: "/user/form/:id()",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_id_-CSY_kXSX.mjs').then((m) => m.default || m)
  },
  {
    name: "user-form",
    path: "/user/form",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-CupGJ-SV.mjs').then((m) => m.default || m)
  },
  {
    name: "user",
    path: "/user",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-CcFInXdV.mjs').then((m) => m.default || m)
  },
  {
    name: "user-list",
    path: "/user/list",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./list-BOr-MxvR.mjs').then((m) => m.default || m)
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-BEFF1QXc.mjs').then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-iYFgDQe_.mjs').then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-BSz5ldgO.mjs').then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-Bkc9yEd1.mjs').then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-D5Ny9JCr.mjs').then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-owpP4E8e.mjs').then((r) => r.default));
...
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-DS8adpFA.mjs').then((r) => r.default));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-BCe7-UHp.mjs').then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-BsJzlrWg.mjs').then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-nL4yyJYb.mjs').then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-DzASdfoj.mjs').then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-DNeEilhD.mjs').then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-COdA_-bP.mjs').then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-kmMPVbed.mjs').then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-BpLFZjAf.mjs').then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-BhgcEI7q.mjs').then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-GzZc9Hwh.mjs').then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-C0evmsHZ.mjs').then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-BfXssmug.mjs').then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-DVpuvFHY.mjs').then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-BUPgPDOd.mjs').then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-CxPp-lxd.mjs').then((r) => r.default));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-D0R07iM6.mjs').then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-BHAvKJQv.mjs').then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-B5cCTIPU.mjs').then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-BfYeMv_V.mjs').then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-NMkqLvuZ.mjs').then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-IOQ4-OG7.mjs').then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-C27Ydoek.mjs').then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-DgqNEQKN.mjs').then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-D2d_X1V5.mjs').then((r) => r.default));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-h-5vYJEF.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-CKsq9-dl.mjs').then((r) => r.default || r));
...
export { LayoutMetaSymbol as L, PageRouteSymbol as P, _export_sfc as _, useRouter as a, useRuntimeConfig as b, navigateTo as c, useRoute as d, entry$1 as default, appLayoutTransition as e, _wrapIf as f, useNuxtApp as g, asyncDataDefaults as h, injectHead as i, createError as j, useRequestEvent as k, useState as l, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useI18n as u };
