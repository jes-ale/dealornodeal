import { u as useContentDisabled, a as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-CLDhCLnD.mjs';
import { l as useState, b as useRuntimeConfig } from './server.mjs';
...
import { defineComponent, toRefs, computed, useSlots, useSSRContext, h } from 'file:///home/jes/dealornodeal_web/node_modules/vue/index.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-DFce90FL.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-BSz5ldgO.mjs.map
